...
router.route('/')
    ...
    .post(restrictTo('user_management:employees', 'user_actions:create_employee', 'manage_employees'), upload.single('avatar'), employeesController.createEmployee);
...
router.route('/:id')
    ...
    .put(restrictTo('user_management:employees', 'user_actions:edit_employee', 'manage_employees'), upload.single('avatar'), employeesController.updateEmployee)
    .patch(restrictTo('user_management:employees', 'user_actions:edit_employee', 'manage_employees'), upload.single('avatar'), employeesController.updateEmployee)
