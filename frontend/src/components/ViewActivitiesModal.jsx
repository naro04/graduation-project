...
const ViewActivitiesModal = ({ isOpen, onClose, locationName, activities = [], onEditActivity, onViewEmployees }) => {
                            ...
                            activities.map((activity) => (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-[8px]">
                                        ...
                                        <span className={`px-[12px] py-[4px] rounded-[4px] text-[12px] font-medium ${activity.status === 'Active'
